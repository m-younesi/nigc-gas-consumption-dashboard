...
def build_pptx():
    ...
    textbox(s, Inches(0.8), Inches(6.0), Inches(11.7), Inches(0.9),
            ...
            + "%s · گزارش %s" % (cfg("shared.scope",
                                     "۳۱ استان · ۱۲ پلهٔ دورهٔ گرم · ۴ پلهٔ دورهٔ سرد"),
    ...
    chart_slides = [
        ...
        ("season.png", "دو فصل",
         ...
         f"از {fa(NAT['h2_intensity_g']['very'])}× در دورهٔ سرد به "
         f"{fa(NAT['h1_intensity_g']['very'])}× در دورهٔ گرم."),
    ]
    ...
    left_txt = (
        ...
        "درصد مصرف و درصد تعداد مشترکین بخش خانگی، برای نیمهٔ اول (دورهٔ گرم، ۱۲ پله) "
        "و نیمهٔ دوم (دورهٔ سرد، ۴ پله) سال ۱۴۰۴.\n\n"
        "اعتبارسنجی\n"
...
def build_xlsx():
    ...
    guide = [
        ...
        ("مصرف - دورهٔ گرم", "درصد مصرف در هر یک از ۱۲ پله"),
        ("مشترکین - دورهٔ گرم", "درصد تعداد مشترکین در هر یک از ۱۲ پله"),
        ("دورهٔ سرد", "درصد مصرف و تعداد مشترکین در ۴ پله"),
    ...
    # ---------------------------------------------------- جدول‌های خام ۱۲ پله
    for key, title in [("h1_cons", "مصرف - دورهٔ گرم"), ("h1_count", "مشترکین - دورهٔ گرم")]:
    ...
    lc = ScatterChart()
    lc.title = "منحنی لورنز مصرف گاز خانگی — کل کشور، دورهٔ گرم ۱۴۰۴"
