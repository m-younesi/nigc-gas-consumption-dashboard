...
(function () {
  ...
  function buildStatTiles() {
    var tiles = [
      ...
      {
        v: U.faNum(H.gini, 3), k: "ضریب جینی مصرف در دورهٔ گرم",
  ...
  function updateNotes() {
    ...
    $("#donutNote").innerHTML =
      "در " + (half === "h1" ? "دورهٔ گرم" : "دورهٔ سرد") + "، <b>" + U.faPct(lowCount, 1) +
    ...
    $("#sankeySub").textContent = fr.province + " — " +
      (fh === "h1" ? "دورهٔ گرم، تعرفهٔ ۱۲ پله‌ای" : "دورهٔ سرد، تعرفهٔ ۴ پله‌ای");
    ...
    $("#climateNote").innerHTML =
      ...
      "استان‌های خزری با وجود اقلیم معتدل، بالای خط می‌نشینند — نشانهٔ نقش رطوبت و کیفیت عایق‌بندی.";
    ...
    $("#seasonNote").innerHTML =
      "در دورهٔ سرد، پرمصرف‌ترین گروه کشور تنها <b>" +
      U.faTimes(NAT.h2_intensity_g.very) + "</b> مشترک متوسط گاز می‌سوزاند؛ در دورهٔ گرم " +
      ...
      "اقلیم فقط مصرف را بالا نمی‌برد؛ فاصلهٔ میان مشترکین را هم باز می‌کند.";
  ...
  function buildGiniTiles() {
    ...
    var items = [
      { v: U.faNum(H.gini, 3), k: "جینی کشوری — دورهٔ گرم",
        d: "دورهٔ سرد ۰٫۱۹۰ است، ولی چون آن دوره فقط ۴ پله دارد، دو عدد مستقیماً " +
